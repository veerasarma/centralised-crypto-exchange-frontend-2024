...
// import service
import { cancelOrder } from '../../services/perpetual/PerpetualService'
...
export default function CancelBtn({ orderInfo, type }: any) {
    ...
    const handleSumbit = async () => {
        try {
            ...
            setLoader(true)
            let data = {
                tableId: `${orderInfo.buyorsell}OpenPerpetualOrders_` + orderInfo.pairId,
    ...
    return (
        <>
            <CancelMOdal show={show} setShow={setShow} handleSumbit={handleSumbit} type={type} />
