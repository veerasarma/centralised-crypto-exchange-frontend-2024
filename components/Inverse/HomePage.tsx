...
export default function Spot() {
  ...
  const { showInverse, showOInverse } = useSelector(
  ...
  const pairChange = async (e: any, type: string) => {
    try {
      ...
      if (type == "position") {
        ...
        data = {
          showInverse: checked,
          type: "inverse-showfuture",
        };
      }
      if (type == "open") {
        setCheck({ ...checkMod, ...{ oCheck: !checked } });
        data = {
          showOInverse: checked,
          type: "inverse-showopen",
        };
      }
  ...
  useEffect(() => {
    setCheck({ ...checkMod, ...{ check: showInverse, oCheck: showOInverse } });
  }, [showInverse, showOInverse]);
  const handleClose = () => {
