...
//import service
import { getOrderBook } from "../../services/inverse/InverseService";
import { setOrderBookPrice } from "@/store/inverse/dataSlice";
...
export default function OrderBook() {
  ...
  useEffect(() => {
    ...
    // // socket
    socketContext.inverSocket.on("usdtPerOrderBook", (result: any) => {
    ...
    return () => {
      socketContext.inverSocket.off("usdtPerOrderBook");
    };
