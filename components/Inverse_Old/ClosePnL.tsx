...
//improt service
import { getOrderHistory } from "../../services/inverse/InverseService";
...
export default function OrderHistory() {
  ...
  useEffect(() => {
    if (!isEmpty(tradePair._id) && isLogin && !isEmpty(currentPage)) {
      ...
      // socket
      socketContext.inverSocket.on("inverseClosedPnL", (result: any) => {
      ...
      return () => {
        socketContext.inverSocket.off("inverseClosedPnL");
      };
    }
  }, [tradePair, isLogin]);
