...
//import service
import { getRecentTrade } from "../../services/inverse/InverseService";
...
export default function RecentTrade() {
  ...
  useEffect(() => {
    ...
    socketContext.inverSocket.on("usdtPerRecentTrade", fetchRecentTradeWs);
    return () => {
      socketContext.inverSocket.off("usdtPerRecentTrade");
    };
  }, [tradePair]);
