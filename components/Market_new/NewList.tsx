...
const NewList = ({ pairList, spotMark }: any) => {
    // redux
    ...
    return (
        <>
            ...
            <div>{
                data && data.length > 0 && data.slice(0, 5).map((item: any, key: any) => {
                    return (
                        <>

                            <a href={`/spot/${item.firstCurrencySymbol}_${item.secondCurrencySymbol}`} className={styles.dflex} target="_blank">
                                <div>
                                    <Image
                                ...
                                <div>
                                    <p className={toFixed(item.Change, 2) > 0 ? styles.green_text : styles.red_text}>{item.Change}%</p>
                                </div>
                            </a>
