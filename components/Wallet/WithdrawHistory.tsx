    ...
    return (
        <>
            <Table responsive  >
                ...
                <tbody>
                    {
                        record?.data?.length > 0 ? (record.data.map((item: any, index: number) => {
                            return (
                                <tr>
                                    <td>{item.date}</td>
                                    <td>{item.type}</td>
                                    ...
                                    <td>{item.txid}</td>
                                    <td>{item.status}</td>
                                    {/* <button className={`mb-4 ${styles.primary_btn}`} >{loader ? <i className="fa fa-spinner fa-spin" ></i> : 'Cancel'}</button> */}
                                </tr>
                            )
                        })
                        ) : (
