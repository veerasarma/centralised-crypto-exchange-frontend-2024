          ...
          >
            ...
            <Offcanvas.Body>
              <Nav className="justify-content-center flex-grow-1">
                ...
                {session?.signedIn && isClient && (
                  <>
                    <Nav.Link href="/affiliateProgram" className="nav-link d-lg-none">Affiliate Plans</Nav.Link>
                    <Nav.Link href="/affiliateUserDetail" className="nav-link d-lg-none">Affiliate Details</Nav.Link>
                    <Dropdown
